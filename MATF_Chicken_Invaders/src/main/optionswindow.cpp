...
void OptionsWindow::volumeChanged() { mw->setVolume(ui->volumeSlider->value()); }
...
OptionsWindow::OptionsWindow(MainWindow *parent) : QDialog(parent), ui(new Ui::OptionsWindow), mw(parent)
{
      ui->setupUi(this);
