      ...
      timer(new QTimer(this))
{
      ...
      QGraphicsPixmapItem *pm =
          scene->addPixmap(QPixmap(":images/backgrounds/choosethelevel.png").scaled(width, height));
      pm->setPos(0, 0);

      connects();
}

ChooseLevelWindow::~ChooseLevelWindow() { delete ui; }

int ChooseLevelWindow::getDesiredLevel() const { return desiredLevel; }

void ChooseLevelWindow::setDesiredLevel(int value) { desiredLevel = value; }
