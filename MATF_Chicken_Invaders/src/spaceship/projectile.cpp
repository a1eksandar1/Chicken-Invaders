...
QPointF Projectile::getPosition() { return pos(); }
...
void Projectile::colision()
{
      ...
      for (auto colItem : colliding_items)
      {
            ...
            else if (typeid(*colItem) == typeid(BigChicken))
            {
                  ...
                  bChicken->setPos(bChicken->pos().x() + bChicken->getXOrientation(),
                                   bChicken->pos().y() - bChicken->getYOrientation());
                  bChicken->die();
            ...
            else if (typeid(*colItem) == typeid(bigEgg))
            {
                  ...
                  if (bEgg->getCurrHealth() == 75)
                        bEgg->setPixmap(
                            QPixmap(":images/chicken/bigEgg_cl1.png").scaled(500, 500, Qt::KeepAspectRatio));
                  else if (bEgg->getCurrHealth() == 50)
                        bEgg->setPixmap(
                            QPixmap(":images/chicken/bigEgg_cl2.png").scaled(500, 500, Qt::KeepAspectRatio));
                  else if (bEgg->getCurrHealth() == 25)
                        bEgg->setPixmap(
                            QPixmap(":images/chicken/bigEgg_cl3.png").scaled(500, 500, Qt::KeepAspectRatio));
