...
RoastChicken::RoastChicken(MainWindow *parent) : mw(parent)
{
...
void RoastChicken::move()
{
      if (!mw->getFreezeScene())
      {
            ...
            setPixmap(QPixmap(":images/chicken/roastChicken.png")
                          .scaled(height / 10, height / 10, Qt::KeepAspectRatio)
...
bool RoastChicken::getStop() const { return stop; }

void RoastChicken::setStop(bool value) { stop = value; }
