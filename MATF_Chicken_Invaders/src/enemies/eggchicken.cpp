...
void EggChicken::advance(int step)
{
      ...
      if (!mw->getFreezeScene())
      {
            if (!isEgg)
            {
                  ...
                  {
                        if (imgChange == 0)
                              setPixmap(QPixmap(":images/chicken/greenchicken.png")
                                            .scaled(width / 12, height / 10, Qt::KeepAspectRatio));
                        if (imgChange == 1)
                              setPixmap(QPixmap(":images/chicken/greenchicken2.png")
                                            .scaled(width / 12, height / 10, Qt::KeepAspectRatio));
                  ...
                  {
                        if (imgChange == 0)
                              setPixmap(QPixmap(":images/chicken/bluechicken.png")
                                            .scaled(width / 12, height / 10, Qt::KeepAspectRatio));
                        if (imgChange == 1)
                              setPixmap(QPixmap(":images/chicken/bluechicken2.png")
                                            .scaled(width / 12, height / 10, Qt::KeepAspectRatio));
                        if (imgChange == 3) return;
                  ...
                  {
                        if (imgChange == 0)
                              setPixmap(QPixmap(":images/chicken/pinkchicken.png")
                                            .scaled(width / 12, height / 10, Qt::KeepAspectRatio));
                        if (imgChange == 1)
                              setPixmap(QPixmap(":images/chicken/pinkchicken2.png")
                                            .scaled(width / 12, height / 10, Qt::KeepAspectRatio));
                        if (imgChange == 3) return;
