...
"}"));
        ...
        hof_button = new QPushButton(centralwidget);
        hof_button->setObjectName(QString::fromUtf8("hof_button"));
        sizePolicy.setHeightForWidth(hof_button->sizePolicy().hasHeightForWidth());
        hof_button->setSizePolicy(sizePolicy);
        hof_button->setStyleSheet(QString::fromUtf8("#hof_button {\n"
"background-color: transparent;\n"
...
"}"));
        ...
        gridLayout->addWidget(hof_button, 2, 2, 1, 1);
